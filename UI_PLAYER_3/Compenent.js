import { createlement } from "./Script/main.js";
var counter = -1
var Precentages = []
...
object1.show(100)
let object2 = new Compenent_Player_Status("status","500","ll",1)
object2.show(100)
let object3 = new Compenent_Player_Status("status","GGGGG","EEE",1)
object3.show(100)

let object4 = new Compenent_Player_Status("status","GGGGG","EEE",1)
object4.show(100)
let object5 = new Compenent_Player_Status("status","GGGGG","EEE",1)
object5.show(100)
let object6 = new Compenent_Player_Status("status","GGGGG","EEE",1)
object6.show(100)
let object7 = new Compenent_Player_Status("status","GGGGG","EEE",1)
object7.show(100)
